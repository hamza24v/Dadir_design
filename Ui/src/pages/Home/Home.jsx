...
function Home() {
    ...
    return (
        <div className=" mt-20 p-4 max-w-sm mx-auto flex-col">
            ...
            {/* <button onClick={<QuoteDialog handleClose={() => setShowQuoteForm(false)}/>} className="mt-5 bg-orange-400 hover:bg-orange-600 text-white font-bold py-2 px-4 rounded"> Get a Free Quote</button> */}
            <Button
                variant="contained"
                color="primary"
