...
function ServiceCard({ title, description }) {
    ...
    return (
        <div className="group w-[400px] h-auto p-5 m-2 bg-blue-200 border border-gray-300 shadow-md hover:shadow-xl rounded-lg cursor-pointer transition-all duration-300 ease-in-out transform"
